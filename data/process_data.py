...
def load_data(messages_filepath, categories_filepath):
    """
    This functions loads the relevant data and merges both tables

    Parameters:
        messages_filepath: string of path to message dataset
        categories_filepath: string of path to categories dataset

    Returns:
        df: DataFrame with merges datasets
    """
...
def save_data(df, database_filename):
    """
    Function for saving DataFrame to tabel in SQL database
